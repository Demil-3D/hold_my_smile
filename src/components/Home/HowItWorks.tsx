  ...
  return (
    <div className="pb-12 bg-slate-100 -mb-12" id="about">
      ...
      <section className={`w-full mx-auto px-6 md:px-12 pt-12 pb-24`}>
        <div className="w-full max-w-3xl mx-auto inset-shadow-sm border p-4 md:p-8 flex max-md:flex-col items-start gap-12">
          <div className="flex-1 flex flex-col gap-4">
            ...
            <div className="w-full">
              <legend className="text-lg font-semibold text-accent mb-1">
                Trusted by practices like St James Dental Practice
              </legend>
            </div>
          </div>
        </div>
